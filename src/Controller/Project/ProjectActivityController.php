...
class ProjectActivityController extends AbstractController
{
    ...
    public function index(ProjectActivityRepository $projectActivityRepository, ProjectRepository $projectRepository, PaginatorInterface $paginator, Request $request, ProjectAccessService $projectAccessService): Response
    {
    ...
    public function new(Request $request, ProjectRepository $projectRepository, ProjectAccessService $projectAccessService): Response
    {
    ...
    public function show(ProjectActivity $projectActivity, ProjectRepository $projectRepository, Request $request, ProjectAccessService $projectAccessService): Response
    {
    ...
    public function edit(Request $request, ProjectActivity $projectActivity, ProjectRepository $projectRepository, ProjectAccessService $projectAccessService): Response
    {
    ...
    public function delete(Request $request, ProjectActivity $projectActivity, ProjectRepository $projectRepository, ProjectAccessService $projectAccessService): Response
    {
